...
function useCategoryName(categorySlug: string) {
    ...
    return React.useMemo(() => Object.values(categoriesWithDicts).find((c) => c.slug === categorySlug)?.name || "", [categorySlug])
}
...
export function CategoryTitle() {
    ...
    return <Head>
        <title>{categoryName} {subcategoryName} смотреть онлайн</title>
    </Head>
}